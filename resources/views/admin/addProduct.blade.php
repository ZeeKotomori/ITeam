        ...
        <aside class="hamberg bg-gradient-to-t from-primary to-link flex flex-col justify-start w-72 h-dashboard my-8 rounded-lg
          hb-max:fixed hb-max:w-60 hb-max:-translate-x-80 z-10 duration-300">
            ...
            <ul>
                ...
                <a href="/productList" class="hover:bg-secondary rounded-lg m-3 flex items-center text-slate-300 hover:text-text opacity-60 hover:opacity-100 duration-300">
        ...
        <div class="text-text hb:h-dashboard ml-8 my-8 w-full h-full
          hb-max:ml-0">
            ...
            <div class="w-full h-fit mt-[5%]">
                <form class="grid grid-cols-2 grid-rows-[42px_auto_auto_50px_auto] gap-4 gap-x-12  rounded-lg py-8 h-[32rem]
                  md-max:grid-cols-1 md-max:grid-rows-[auto_42px_auto_auto_auto] md-max:h-fit" action="">
                    <div class="grid place-content-center row-span-4 h-full bg-form rounded-md
                      md-max:order-1 md-max:row-span-1 md-max:h-56">
                        <input class="text-transparent file:w-full file:py-2 file:px-4 file:rounded-full file:border-0 file:font-semibold file:bg-link file:text-text file:hover:bg-indigo-600/70" type="file" id="files">
                        <label class="cursor-pointer text-center mt-2" for="files" id="imgUpload">Tidak ada file yang dipilih</label>
                    </div>
                    <input class="h-fit p-2 bg-transparent border-b-2 border-link outline-none md-max:order-2" placeholder="Title" type="text">
                    <textarea class="h-full p-2 bg-transparent border-b-2 border-link outline-none resize-none md-max:order-3" placeholder="Description" rows="8" cols="50" id="textArea"></textarea>
                    <input class="h-fit p-2 bg-transparent border-b-2 border-link outline-none md-max:order-4" placeholder="Link" type="text">
