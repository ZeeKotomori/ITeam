    ...
    <div class="opacity-0 hidden md:opacity-100 md:pt-4 md:pl-4 md:block md:mb-10 ">
        ...
        <div class="md:justify-center md:flex">
            <div class="form flex flex-col rounded-xl md:bg-form md:relative md:p-8">
                ...
                <form class="text-text flex flex-col justify-center gap-y-2 pt-8 md:px-10" action="{{ route('logIn') }}">
                    @csrf
                    ...
                    <div class="flex justify-between pt-8">
                        ...
                        <span class="w-44 text-sm text-right">Don't have an account? <a class="text-link underline" href="/">Sign Up</a></span>
                        </div>
                    </form>
                </div>
            </div>
