...
<body class="relative bg-gradient-dark font-manrope overflow-x-hidden" data-scroll-container>
    ...
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide w-10/12 md:w-9/12">
                <img class="w-full rounded-lg block md:hidden" src="{{asset("svg/Casio Piano m.svg")}}" alt="Carousel Casio Piano">
                <img class="m-auto rounded-lg hidden md:block" src="{{asset("svg/Casio Piano.svg")}}" alt="Carousel Casio Piano">
            </div>
            <div class="swiper-slide w-10/12 md:w-9/12">
                <img class="w-full rounded-lg block md:hidden" src="{{asset("svg/Kerg Analogue Performan m.svg")}}" alt="Carousel Kerg Analogue">
                <img class="m-auto rounded-lg hidden md:block" src="{{asset("svg/Kerg Analogue Performan.svg")}}" alt="Carousel Kerg Analogue">
            </div>
            <div class="swiper-slide w-10/12 md:w-9/12">
                <img class="w-full rounded-lg block md:hidden" src="{{asset("svg/Yamaha Keyboard m.svg")}}" alt="Carousel Yamaha Keyboard">
                <img class="m-auto rounded-lg hidden md:block" src="{{asset("svg/Yamaha Keyboard.svg")}}" alt="Carousel Yamaha Keyboard">
            </div>
            <div class="swiper-slide w-10/12 md:w-9/12">
                <img class="w-full rounded-lg block md:hidden" src="{{asset("svg/Casio Piano m.svg")}}" alt="Carousel Casio Piano">
                <img class="m-auto rounded-lg hidden md:block" src="{{asset("svg/Casio Piano.svg")}}" alt="Carousel Casio Piano">
    ...
    <div class="w-10/12 m-auto mt-24 md:w-9/12">
        ...
        <div class="flex justify-between pb-8 md:justify-center md:gap-x-32">
            <img class="w-1/4 md:w-[14%]" src="{{asset("svg/korg.svg")}}" alt="Korg logo">
            <img class="w-1/4 p-4 md:w-[14%]" src="{{asset("svg/yamaha.svg")}}" alt="Yamaha logo">
            <img class="w-1/4 md:w-[14%]" src="{{asset("svg/casio.svg")}}" alt="Casio logo">
        </div>
    ...
    <div class="bg-gradient-to-b from-gradient-dark to-gradient-light">
        <div class="bg-no-repeat bg-cover bg-center" style="background-image: url('{{ asset('svg/sirkel.svg') }} ');">
            <div class="recommend text-text w-10/12 m-auto md:w-9/12">
                ...
                <div class="pt-20">
                    <div class="text-right mb-24 hb:mb-48 hb:flex">
                        <img class="w-full rounded-lg hb:w-1/2 hb:max-w-[60%]" src="{{asset("svg/Yamaha_img.svg")}}" alt="Yamaha Keyboard">
                        <div class="my-auto hb:pl-8 hb:w-1/2">
                            ...
                            <a href="https://usa.yamaha.com/products/musical_instruments/keyboards/index.html"><button class="bg-link px-6 py-1 rounded-lg mt-4">Buy -></button></a>
                        </div>
                    </div>
                    <div class="mb-24 hb:mb-48 hb:flex flex-row-reverse">
                        <img class="w-full rounded-lg hb:w-1/2 hb:max-w-[60%]" src="{{asset("svg/Korg_img.svg")}}" alt="Korg Volca Mix">
                        <div class="my-auto hb:pr-8 hb:w-1/2">
                            ...
                            <a href="https://www.korg.com/us/products/dj/volca_mix/"><button class="bg-link px-6 py-1 rounded-lg mt-4">Buy -></button></a>
                        </div>
                    </div>
                    <div class="text-right pb-24 hb:pb-32 hb:flex">
                        <img class="w-full rounded-lg hb:w-1/2 hb:max-w-[60%]" src="{{asset("svg/Celviano_img.svg")}}" alt="Celviano Grand Hybrid">
                        <div class="my-auto hb:pl-8 hb:w-1/2">
                            ...
                            <a href="https://www.casio.com/us/electronic-musical-instruments/celviano/grand-hybrid/"><button class="bg-link px-6 py-1 rounded-lg mt-4">Buy -></button></a>
                        </div>
